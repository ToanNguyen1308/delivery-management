...
@Tag(name = "11. File", description = "Upload file len MinIO")
public class FileController {

    private final FileStorageService fileStorageService;

    @PostMapping(value = "/upload-temp", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    @Operation(summary = "Upload file vao thu muc temp",
            description = "File nam o temp cho den khi nghiep vu xac nhan roi moi chuyen sang thu muc dich")
    ...
    @Operation(summary = "Upload thang vao thu muc nghiep vu")
